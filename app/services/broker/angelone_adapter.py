...
class AngelOneAdapter:
    ...
    def build_option_symbol(self, underlying: str, expiry_dt: datetime, 
    ...
    def get_option_chain(self, underlying: str, spot: Optional[float] = None,
                         strikes_range: int = 5) -> Dict[str, any]:
        ...
        try:
            ...
            logger.info(f"Option chain fetched: {underlying} {expiry_str} (ATM {atm}, strikes: {list(chain['strikes'].keys())})")
            return chain
