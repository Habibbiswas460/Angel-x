...
from src.utils.exit_models import PartialExitState, PartialExitSignal, Phase7Config
...
class PartialExitEngine:
    ...
    def check_partial_exit_eligibility(
        ...
        # Calculate profit
        profit_percent = self._calculate_profit_percent(entry_price, current_price, option_type)
