...
class OiBuildUpClassifier:
    ...
    def classify_strike(
        ...
        logger.debug(f"Strike {strike} {option_type}: {buildup_type.value} " f"(confidence={confidence:.2f})")
    ...
    def get_metrics(self) -> Dict:
        ...
        return {
            ...
            "long_unwinding": self.long_unwinding_count,
            "neutral": self.neutral_count,
            "high_conviction_percentage": ((self.long_buildup_count + self.short_buildup_count) / max(total, 1) * 100),
        }
