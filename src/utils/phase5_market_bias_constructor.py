...
from src.utils.phase5_market_bias_models import (
    BiasType, BiasStrength, BiasAnalysis, StrengthAnalysisDetails,
    Phase5Config, validate_bias_type, is_strong_bias
)
...
class MarketBiasConstructor:
    ...
    def detect_bias(
        ...
        reasoning = self._generate_reasoning(
            bias_type, bias_strength, ce_dominance, gamma_support, delta_alignment
        )
