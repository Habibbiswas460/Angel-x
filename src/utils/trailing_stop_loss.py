...
from src.utils.exit_models import TrailingSLState, TrailTrigger, Phase7Config
    ...
    def update_trail(
        ...
        if moved:
            ...
            if current_trail_state.activation_price is not None:
                ...
                current_trail_state.max_trail_gained = max(current_trail_state.max_trail_gained, profit_locked)
