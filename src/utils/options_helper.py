...
class OptionsHelper:
    ...
    def compute_offset(
        self, underlying: str, expiry_date: str, strike: float, option_type: str, exchange: str = None
    ) -> str:
    ...
    def place_multi_leg_order(self, underlying, legs, exchange=None, expiry_date=None):
        ...
        try:
            ...
            # Build kwargs
            kwargs = {"strategy": self.strategy, "underlying": underlying, "exchange": exchange, "legs": legs}
    ...
    def get_option_chain(self, underlying, expiry_date, exchange=None, strike_count=None):
        ...
        try:
            ...
            kwargs = {"underlying": underlying, "exchange": exchange, "expiry_date": expiry_date}
    ...
    def get_option_greeks(
        self, symbol, exchange="NFO", interest_rate=0.0, underlying_symbol=None, underlying_exchange=None
    ):
        """
    ...
    def get_option_symbol(self, underlying, expiry_date, offset, option_type, exchange=None):
        """
    ...
    def get_synthetic_future(self, underlying, expiry_date, exchange=None):
        ...
        try:
            ...
            response = self.client.syntheticfuture(underlying=underlying, exchange=exchange, expiry_date=expiry_date)
    ...
    def get_expiry_dates(self, symbol, exchange="NFO", instrumenttype="options"):
        ...
        """
        try:
            response = self.client.expiry(symbol=symbol, exchange=exchange, instrumenttype=instrumenttype)
