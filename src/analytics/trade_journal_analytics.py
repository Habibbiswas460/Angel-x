...
class TradeJournalAnalytics:
    ...
    def get_entry_analysis(self) -> Dict:
        ...
        for reason in entry_stats:
            entry_stats[reason]['avg_pnl'] = (
                entry_stats[reason]['total_pnl'] / entry_stats[reason]['count']
            )
            entry_stats[reason]['win_rate'] = (
                entry_stats[reason]['wins'] / entry_stats[reason]['count'] * 100
            )
    ...
    def get_exit_analysis(self) -> Dict:
        ...
        for reason in exit_stats:
            exit_stats[reason]['avg_hold_sec'] = int(
                exit_stats[reason]['avg_hold_sec'] / exit_stats[reason]['count']
            )
            exit_stats[reason]['win_rate'] = (
                exit_stats[reason]['wins'] / exit_stats[reason]['count'] * 100
            )
    ...
    def get_time_analysis(self) -> Dict:
        ...
        for hour in hour_stats:
            hour_stats[hour]['avg_pnl'] = (
                hour_stats[hour]['total_pnl'] / hour_stats[hour]['count']
            )
            hour_stats[hour]['win_rate'] = (
                hour_stats[hour]['wins'] / hour_stats[hour]['count'] * 100
            )
    ...
    def get_strike_selection_analysis(self) -> Dict:
        ...
        for strike in strike_stats:
            strike_stats[strike]['avg_pnl'] = (
                strike_stats[strike]['total_pnl'] / strike_stats[strike]['count']
            )
            strike_stats[strike]['win_rate'] = (
                strike_stats[strike]['wins'] / strike_stats[strike]['count'] * 100
            )
