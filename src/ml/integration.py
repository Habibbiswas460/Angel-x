...
class MLIntegration:
    ...
    def train(self, df) -> Dict[str, Any]:
        ...
        if len(X) == 0:
            ...
            return {"lstm": None, "patterns": None, "train_samples": 0, "test_samples": 0, "skipped": True}
    ...
    def infer(self, df) -> Dict[str, Any]:
        ...
        if self.lstm is None or self.patterns is None:
            ...
            return {"direction_preds": [], "class_preds": [], "skipped": True}
        ...
        try:
            ...
            return {"direction_preds": preds_dir.tolist(), "class_preds": preds_cls.tolist(), "skipped": False}
        except Exception as e:
            logger.error(f"ML infer error: {e}")
            return {"direction_preds": [], "class_preds": [], "error": str(e), "skipped": True}
