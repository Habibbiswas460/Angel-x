...
from src.dashboard.post_trade_analytics import PostTradeAnalytics, CompletedTrade, ExitReason
...
class DashboardAggregator:
    ...
    def build_option_chain_view(self) -> OptionChainView:
        ...
        return OptionChainView(timestamp=datetime.now(), atm_strike=atm_strike, strikes=option_strikes)
    ...
    def build_trade_monitor(self) -> LiveTradeMonitor:
        ...
        if not self.active_position:
            return LiveTradeMonitor(timestamp=datetime.now(), has_position=False)
...
class DashboardDataFeeder:
    ...
    def get_sample_option_chain() -> Dict:
        ...
        return {"atm_strike": atm, "strikes": strikes_data}
