...
class SmartExitEngine:
    ...
    def _check_trailing_stop(
        self, trade_id, current_price, entry_price, delta, gamma, theta, iv, holding_sec, pnl_pct, now
    ) -> Optional[ExitSnapshot]:
    ...
    def _check_profit_ladder(
        self, trade_id, pnl_pct, current_price, quantity, exited_qty, delta, gamma, theta, iv, holding_sec, now
    ) -> Optional[ExitSnapshot]:
