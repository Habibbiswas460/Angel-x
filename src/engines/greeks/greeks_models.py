...
class GreeksSnapshot:
    ...
    def has_greek_movement(self) -> bool:
        ...
        return (
            abs(self.delta_change or 0) > threshold or
            abs(self.gamma_expansion or 0) > threshold or
            abs(self.theta_spike or 0) > threshold or
            abs(self.vega_surge or 0) > threshold
        )
