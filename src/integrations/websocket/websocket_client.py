...
class WebSocketClient:
        ...
        try:
            ...
            subscription_msg = {
                ...
                "params": {
                    ...
                    "tokenList": [
                        {
                            "exchangeType": self._get_exchange_code(exchange),
                            "tokens": tokens
                        }
                    ]
                }
        ...
        while self.is_running:
            try:
                ...
                if self.is_running:
                    ...
                    delay = min(
                        self.reconnect_delay * (self.reconnect_multiplier ** reconnect_attempt),
    ...
    def _parse_binary_message(self, message: bytes) -> Dict:
        ...
        SmartAPI sends data in binary format for efficiency
        """
        # TODO: Implement binary parsing based on SmartAPI documentation
