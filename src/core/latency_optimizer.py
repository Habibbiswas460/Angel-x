...
class LatencyOptimizer:
    ...
    def optimize_signal_path(
        self, raw_market_data: Dict, calculate_greeks: bool = True, use_cache: bool = True
    ) -> Dict:
        """
        ...
        return {"data": processed_data, "latency_ms": total_latency_ms, "optimizations_applied": processed_data["mode"]}
