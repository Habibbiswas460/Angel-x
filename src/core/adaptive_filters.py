...
class AdaptiveSignalFilter:
    ...
    def evaluate_signal(self, signal_data: Dict) -> Dict:
        ...
        market = self.assess_market_condition(signal_data.get("current_iv", 20), signal_data.get("oi_data", {}))
    ...
    def get_filter_efficiency(self) -> Dict:
        ...
        if self.total_signals == 0:
            return {"total_signals": 0, "passed": 0, "rejection_rate": 0.0, "top_rejection_reasons": []}
