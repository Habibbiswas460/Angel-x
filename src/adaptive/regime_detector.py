...
class MarketRegimeDetector:
    ...
    def get_current_posture(self) -> Dict:
        ...
        if not self.current_regime:
            return {
                "regime": "UNKNOWN",
                "confidence": 0.0,
                "recommendations": {"trade_frequency": "NORMAL", "position_size": "NORMAL", "holding_style": "NORMAL"},
            }
    ...
    def should_reduce_trading(self) -> bool:
        ...
        cautious_regimes = [MarketRegime.HIGH_VOLATILITY, MarketRegime.CHOPPY, MarketRegime.EVENT_DRIVEN]
    ...
    def get_size_multiplier(self) -> float:
        ...
        size_map = {"NORMAL": 1.0, "REDUCED": 0.7, "MINIMAL": 0.5}
    ...
    def get_frequency_multiplier(self) -> float:
        ...
        freq_map = {"NORMAL": 1.0, "REDUCED": 0.7, "MINIMAL": 0.5}
