...
class SafetyGuardSystem:
    ...
    def propose_learning_update(self, proposal_type: str, details: Dict, confidence: float) -> LearningProposal:
        """
    ...
    def shadow_test_proposal(self, proposal: LearningProposal, historical_data: List[Dict]) -> Dict:
        """
    ...
    def get_safety_status(self) -> Dict:
        ...
        return {
            ...
            "approved_today": len(
                [p for p in self.approved_proposals if p.approved_at and p.approved_at.date() == now.date()]
            ),
            "recent_violations": [
                {
