...
class ConfidenceScorer:
    ...
    def score_signal(
        ...
        # Explanation
        explanation = self._generate_explanation(confidence_score, hist_score, regime_score, recent_score, sample_score)
    ...
    def _calculate_historical_score(
        self, buckets: List[FeatureBucket], bucket_perf: Dict[FeatureBucket, BucketPerformance]
    ) -> float:
        """
    ...
    def _calculate_regime_score(self, buckets: List[FeatureBucket], current_regime: MarketRegime) -> float:
        """
    ...
    def _generate_explanation(self, total: float, hist: float, regime: float, recent: float, sample: float) -> str:
