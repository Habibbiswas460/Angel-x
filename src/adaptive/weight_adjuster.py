    ...
    def _initialize_default_weights(self):
        ...
        for bucket in [
            ...
            self.rule_weights[key] = RuleWeight(
                rule_type=RuleType.TIME_FILTER, feature_bucket=bucket, current_weight=1.0, base_weight=1.0
            )
        ...
        for bucket in [FeatureBucket.OI_STRONG, FeatureBucket.OI_MEDIUM, FeatureBucket.OI_WEAK]:
            ...
            self.rule_weights[key] = RuleWeight(
                rule_type=RuleType.OI_CONVICTION, feature_bucket=bucket, current_weight=1.0, base_weight=1.0
            )
        ...
        for bucket in [FeatureBucket.GREEKS_HIGH_GAMMA, FeatureBucket.GREEKS_HIGH_THETA]:
            ...
            self.rule_weights[key] = RuleWeight(
                rule_type=RuleType.GREEKS_THRESHOLD, feature_bucket=bucket, current_weight=1.0, base_weight=1.0
            )
        ...
        for bucket in [FeatureBucket.VOL_LOW, FeatureBucket.VOL_NORMAL, FeatureBucket.VOL_HIGH]:
            ...
            self.rule_weights[key] = RuleWeight(
                rule_type=RuleType.VOLATILITY_FILTER, feature_bucket=bucket, current_weight=1.0, base_weight=1.0
            )
