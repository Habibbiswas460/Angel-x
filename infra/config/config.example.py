...
# ============================================================================
# OpenAlgo settings removed in example — use broker config below
...
ANALYZER_MODE = True  # Analyzer mode (simulated responses)

# ============================================================================
# Notification Settings
# ============================================================================
ENABLE_NOTIFICATIONS = False
BROKER_TELEGRAM_USERNAME = ""  # Your broker/alert username for telegram alerts
